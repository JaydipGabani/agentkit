...
- Mermaid.js is loaded from an exact-version CDN URL with subresource integrity in the template. If you don't use any mermaid diagrams, delete that `<script>` element so the file is fully self-contained.
